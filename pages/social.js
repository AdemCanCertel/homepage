...
export default function SocialPage() {
    return (
        <section className='full-container'>
            <h1 className="font-bold dark:text-white text-black text-2xl md:text-3xl text-highlight">Social</h1>
            ...
            <div className="mt-10">
                ...
                <div className="mt-4 grid grid-cols-4 gap-4">
                    <a href="https://www.patreon.com/ademcan" target="_blank" className="px-4 py-2 flex space-x-4 hover:text-gray-400/100 transition delay-75">
                       <span className="font-bold">Patreon</span>
                    </a>
                    <a href="https://superpeer.com/ademcancertel" target="_blank" className="px-4 py-2 flex space-x-4 hover:text-gray-400/100 transition delay-75">
                        <span className="font-bold">Superpeer</span>
                    </a>
                </div>
            </div>
        </section>
