        ...
        <section className='full-container'>
            ...
            <div className="mt-10">
                ...
                <div className="mt-4 grid grid-cols-4 gap-4">
                    <a href="https://www.patreon.com/ademcan" target="_blank" className="w-full lg:w-max sm:w-max px-4 py-2 flex space-x-4 bg-[#ff6871] rounded items-center justify-center">
                     <FaPatreon size={22} />
                       <span className="font-bold">Patreon</span>
                    </a>
                    <a href="https://superpeer.com/ademcancertel" target="_blank" className="w-full lg:w-max sm:w-max px-4 py-2 flex space-x-4  bg-[#fff7e4] dark:bg-[#272827] rounded">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-5" viewBox="0 0 50 55" fill="none">
